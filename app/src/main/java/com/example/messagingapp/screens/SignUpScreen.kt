...
@Composable
fun SignUpScreen(navController: NavHostController, viewModel: AuthetificationViewModel) {
    ...
    Column(
        ...
        MyTextField(
            ...
            validator = { viewModel.repeatPasswordValidator(repeatPassword) },
            errorMessage = { viewModel.repeatPasswordErrorMessage(context,repeatPassword) }
        )
